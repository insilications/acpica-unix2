...
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20191213.tar.gz
...
%prep
%setup -q -n acpica-unix2-20191213
cd %{_builddir}/acpica-unix2-20191213
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576508447
