...
Version  : 20181031
Release  : 37
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20181031.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20181031.tar.gz
...
%prep
%setup -q -n acpica-unix2-20181031
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1541037801
make  %{?_smp_mflags}
