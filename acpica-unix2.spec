...
Version  : 20201113
Release  : 55
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20201113.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20201113.tar.gz
...
%prep
%setup -q -n acpica-unix2-20201113
cd %{_builddir}/acpica-unix2-20201113
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605297570
