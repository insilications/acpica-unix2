...
Version  : 20201217
Release  : 56
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20201217.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20201217.tar.gz
...
%prep
%setup -q -n acpica-unix2-20201217
cd %{_builddir}/acpica-unix2-20201217
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608312825
