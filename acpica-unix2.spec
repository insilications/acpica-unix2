...
Version  : 20200430
Release  : 51
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20200430.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20200430.tar.gz
...
%prep
%setup -q -n acpica-unix2-20200430
cd %{_builddir}/acpica-unix2-20200430
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588302860
