...
Version  : 20181003
Release  : 36
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20181003.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20181003.tar.gz
...
%prep
%setup -q -n acpica-unix2-20181003
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1538584577
make  %{?_smp_mflags}
