...
Version  : 20180810
Release  : 33
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20180810.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20180810.tar.gz
...
%prep
%setup -q -n acpica-unix2-20180810
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1533923408
make  %{?_smp_mflags}
