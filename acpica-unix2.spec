...
Version  : 20180531
Release  : 31
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20180531.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20180531.tar.gz
...
%prep
%setup -q -n acpica-unix2-20180531
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1528202942
make  %{?_smp_mflags}
