...
Version  : 20200326
Release  : 50
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20200326.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20200326.tar.gz
...
%prep
%setup -q -n acpica-unix2-20200326
cd %{_builddir}/acpica-unix2-20200326
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585265471
