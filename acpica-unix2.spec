...
Version  : 20181213
Release  : 38
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20181213.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20181213.tar.gz
...
%prep
%setup -q -n acpica-unix2-20181213
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1544881464
make  %{?_smp_mflags}
