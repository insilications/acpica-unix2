...
Version  : 20200214
Release  : 49
URL      : https://acpica.org/sites/acpica/files/acpica-unix2-20200214.tar.gz
Source0  : https://acpica.org/sites/acpica/files/acpica-unix2-20200214.tar.gz
...
%prep
%setup -q -n acpica-unix2-20200214
cd %{_builddir}/acpica-unix2-20200214
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581708127
